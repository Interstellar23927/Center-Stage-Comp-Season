...
public class ContourPipelineBlue2 extends OpenCvPipeline {
    Scalar HOT_PINK = new Scalar(0, 0, 139);

    // Pink, the default color                         Y      Cr     Cb    (Do not change Y)
    public static Scalar scalarLowerYCrCb = new Scalar(0.0, 0.0, 128.0);
    public static Scalar scalarUpperYCrCb = new Scalar(0.0, 0.0, 139.0);
    ...
    public ContourPipelineBlue2(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
